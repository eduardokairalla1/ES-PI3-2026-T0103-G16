...
class _BalcaoPageState extends State<BalcaoPage> {
      ...
      child: Column(
        ...
        children: [
          ...
          if (tab == 'mercado') ...[
            ...
            ..._buildMarketItems(filteredMarket),
          ] else ...[
            ..._buildOrdersItems(),
          ]
        ],
  ...
  List<Widget> _buildMarketItems(List<Map<String, Object>> filteredMarket) {
      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            Column(
              children: [
                _buildActionBtn('Comprar', const Color(0xFFE8F5E9), const Color(0xFF388E3C)),
                const SizedBox(height: 4),
                _buildActionBtn('Vender', const Color(0xFFFBE9E7), const Color(0xFFFF5722)),
              ],
            ),
          ],
        ),
  ...
  Widget _buildActionBtn(String text, Color bgColor, Color textColor) {
    return Container(
